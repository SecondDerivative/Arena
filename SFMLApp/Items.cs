...
namespace SFMLApp
{
    ...
    public static class Items
    {
        ...
        public static void getAllItems()
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ArrayItems.Add(new ItemSword(fileReader.ReadLine(), Int32.Parse(fileReader.ReadLine()), Int32.Parse(fileReader.ReadLine()), i));
            }
            fileReader.ReadLine();
            for (int i = 4; i < 7; i++)
            {
                ArrayItems.Add(new ItemBow(fileReader.ReadLine(), Int32.Parse(fileReader.ReadLine()), Int32.Parse(fileReader.ReadLine()), i));
            }
            fileReader.ReadLine();
            for (int i = 7; i < 10; i++)
            {
                ArrayItems.Add(new Magic(fileReader.ReadLine(), Int32.Parse(fileReader.ReadLine()), Int32.Parse(fileReader.ReadLine()), Int32.Parse(fileReader.ReadLine()), i));
            }
        }
    }
}
